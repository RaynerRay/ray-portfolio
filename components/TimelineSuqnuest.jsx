...
export default function TimelineSunquest() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-10">
          ...
          <p className="mt-6 text-lg text-gray-300 max-w-3xl">
            A timeline outlines a <span className="text-emerald-300">structured plan detailing</span> the <span className="text-fuchsia-400">key phases</span> and activities involved in the design and development of the Sunquestwebsite over a defined period.
          </p>
        </div>
