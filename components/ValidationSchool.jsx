...
const ValidationSchool = () => {
  const testingData = [
    {
      score: "10/10",
      filledUsers: 10,
      description: "Found the system easy to use and straightforward to navigate.",
    },
    {
      score: "7/10",
      filledUsers: 7,
      description: "Understood how to set up staff and pupil profiles and manage timetables.",
    },
    {
      score: "10/10",
      filledUsers: 10,
      description: "Used the filtering tools with minimal confusion.",
    },
    {
      score: "8/10",
      filledUsers: 8,
      description: "Found the assessment and reporting process clear and efficient.",
    },
    {
      score: "8/10",
      filledUsers: 8,
      description: "Would recommend the system to colleagues in other schools.",
    },
  ];
      ...
      <div className="relative z-10">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <p className="text-white/70 text-base sm:text-lg">
            We conducted validation testing of the school management system with 10 educators and administrators. Below is a summary of the key findings:
          </p>
        </div>
